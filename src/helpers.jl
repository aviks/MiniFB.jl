...
function LibMiniFB.mfb_set_mouse_move_callback(window, mouse_move::Function)
    mouse_move_c = @cfunction($mouse_move, Cvoid, (Ptr{Cvoid}, Cint, Cint))
    mfb_set_mouse_move_callback(window, mouse_move_c)
end

function LibMiniFB.mfb_set_mouse_scroll_callback(window, mouse_scroll::Function)
