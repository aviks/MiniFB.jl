...
@cenum mfb_mouse_button::UInt32 begin
    MOUSE_BTN_0 = 0
    MOUSE_BTN_1 = 1
    MOUSE_BTN_2 = 2
    MOUSE_BTN_3 = 3
...
@cenum mfb_key_mod::UInt32 begin
    KB_MOD_SHIFT = 1
    KB_MOD_CONTROL = 2
    KB_MOD_ALT = 4
    KB_MOD_SUPER = 8
...
@cenum mfb_window_flags::UInt32 begin
    WF_RESIZABLE = 1
    WF_FULLSCREEN = 2
...
# Skipping MacroDefinition: MFB_RGB ( r , g , b ) ( ( ( uint32_t ) r ) << 16 ) | ( ( ( uint32_t ) g ) << 8 ) | ( ( uint32_t ) b )
